...
#define DEFAULT_MYSQL_HOME "/media/wanji/WORK/ws/library/mysql-5.7.44/install"
#define SHAREDIR "/media/wanji/WORK/ws/library/mysql-5.7.44/install/share"
#define DEFAULT_BASEDIR "/media/wanji/WORK/ws/library/mysql-5.7.44/install"
#define MYSQL_DATADIR "/media/wanji/WORK/ws/library/mysql-5.7.44/install/data"
#define MYSQL_KEYRINGDIR "/media/wanji/WORK/ws/library/mysql-5.7.44/install/keyring"
#define DEFAULT_CHARSET_HOME "/media/wanji/WORK/ws/library/mysql-5.7.44/install"
#define PLUGINDIR "/media/wanji/WORK/ws/library/mysql-5.7.44/install/lib/plugin"
#define DEFAULT_SYSCONFDIR "/media/wanji/WORK/ws/library/mysql-5.7.44/install/etc"
