...
#ifndef GOOGLE_PROTOBUF_INCLUDED_response_5fmessage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_response_5fmessage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_response_5fmessage_2eproto
...
struct TableStruct_response_5fmessage_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_response_5fmessage_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::lite_monitor::ResponseMessage* Arena::CreateMaybeMessage<::lite_monitor::ResponseMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace lite_monitor {
...
class ResponseMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lite_monitor.ResponseMessage) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "lite_monitor.ResponseMessage";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:lite_monitor.ResponseMessage)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_response_5fmessage_2eproto;
};
// ===================================================================
...
inline int32_t ResponseMessage::_internal_id() const {
  return _impl_.id_;
}
inline int32_t ResponseMessage::id() const {
  // @@protoc_insertion_point(field_get:lite_monitor.ResponseMessage.id)
  return _internal_id();
}
inline void ResponseMessage::_internal_set_id(int32_t value) {
  
  _impl_.id_ = value;
}
inline void ResponseMessage::set_id(int32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:lite_monitor.ResponseMessage.id)
}
...
inline bool ResponseMessage::success() const {
  // @@protoc_insertion_point(field_get:lite_monitor.ResponseMessage.success)
...
inline void ResponseMessage::set_success(bool value) {
  ...
  // @@protoc_insertion_point(field_set:lite_monitor.ResponseMessage.success)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_response_5fmessage_2eproto
